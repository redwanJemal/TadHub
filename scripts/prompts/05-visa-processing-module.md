You are implementing task "Visa Processing Module" for the TadHub project (a Tadbeer maid recruitment SaaS platform).
...
10. After ALL work is done, update the progress file at docs/tasks/progress.json:
    - Set tasks.05-visa-processing-module.status to "completed"
    - Set each subtask to "completed" as you finish them
    - Set tasks.05-visa-processing-module.completed_at to current ISO timestamp
    - Add any important notes to tasks.05-visa-processing-module.notes
11. Finally, create a git commit with message: "feat: implement 05-visa-processing-module — Visa Processing Module"
