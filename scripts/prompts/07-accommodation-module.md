You are implementing task "Accommodation Management Module" for the TadHub project (a Tadbeer maid recruitment SaaS platform).
...
10. After ALL work is done, update the progress file at docs/tasks/progress.json:
    - Set tasks.07-accommodation-module.status to "completed"
    - Set each subtask to "completed" as you finish them
    - Set tasks.07-accommodation-module.completed_at to current ISO timestamp
    - Add any important notes to tasks.07-accommodation-module.notes
11. Finally, create a git commit with message: "feat: implement 07-accommodation-module — Accommodation Management Module"
