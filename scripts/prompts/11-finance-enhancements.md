You are implementing task "Finance Enhancements" for the TadHub project (a Tadbeer maid recruitment SaaS platform).
...
These subtasks have already been tracked:
  - refund-engine: pending
  - commission-calc: pending
  - guarantee-recovery: pending
...
10. After ALL work is done, update the progress file at docs/tasks/progress.json:
    - Set tasks.11-finance-enhancements.status to "completed"
    - Set each subtask to "completed" as you finish them
    - Set tasks.11-finance-enhancements.completed_at to current ISO timestamp
    - Add any important notes to tasks.11-finance-enhancements.notes
11. Finally, create a git commit with message: "feat: implement 11-finance-enhancements — Finance Enhancements"
