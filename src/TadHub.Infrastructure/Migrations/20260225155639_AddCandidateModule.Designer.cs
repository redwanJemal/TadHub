...
namespace SaasKit.Migrations
{
    ...
    [Migration("20260225155639_AddCandidateModule")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Candidate.Core.Entities.Candidate", b =>
                {
                    b.HasOne("Supplier.Core.Entities.TenantSupplier", "TenantSupplier")
                        .WithMany()
                        .HasForeignKey("TenantSupplierId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_candidates_tenant_supplier_tenant_supplier_id");

                    b.Navigation("TenantSupplier");
                });
