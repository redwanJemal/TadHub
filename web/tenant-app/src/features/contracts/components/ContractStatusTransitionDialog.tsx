...
interface ContractStatusTransitionDialogProps {
  open: boolean;
...
export function ContractStatusTransitionDialog({
  open,
  onOpenChange,
  contractId,
  currentStatus,
}: ContractStatusTransitionDialogProps) {
      ...
      <DialogContent>
        ...
        <div className="space-y-4 py-4">
          <div className="space-y-2">
            ...
            <div><ContractStatusBadge status={currentStatus} /></div>
          </div>
