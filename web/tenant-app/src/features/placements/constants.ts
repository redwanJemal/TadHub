...
import type { PlacementStatus, PlacementCostType } from './types';
...
export const ALLOWED_TRANSITIONS: Partial<Record<PlacementStatus, PlacementStatus[]>> = {
  Booked:                   ['ContractCreated', 'Cancelled'],
  ContractCreated:          ['EmploymentVisaProcessing', 'Cancelled'],
  EmploymentVisaProcessing: ['TicketArranged', 'Cancelled'],
...
// Step descriptions for the checklist
