...
export type SupplierPaymentType = 'Regular' | 'Commission' | 'DebitSettlement';
...
// Supplier Debit types
export type SupplierDebitStatus = 'Outstanding' | 'PartiallyPaid' | 'Settled' | 'Waived' | 'Cancelled';

export type SupplierDebitType = 'CommissionRefund' | 'TicketCost' | 'VisaCost' | 'TransportationCost' | 'MedicalCost' | 'AccommodationCost' | 'Other';

export type SupplierDebitCaseType = 'Returnee' | 'Runaway';

export interface SupplierDebitListDto {
  id: string;
  debitNumber: string;
  ...
  workerId?: string;
  contractId?: string;
  caseType?: SupplierDebitCaseType;
  debitType: SupplierDebitType;
  description: string;
  amount: number;
  currency: string;
  createdAt: string;
...
export interface SupplierDebitDto extends SupplierDebitListDto {
  tenantId: string;
  caseId?: string;
...
export interface CreateSupplierDebitRequest {
  supplierId: string;
  workerId?: string;
  contractId?: string;
  caseType?: string;
...
export interface UpdateSupplierDebitRequest {
  description?: string;
  amount?: number;
  notes?: string;
}

export interface TransitionSupplierDebitStatusRequest {
  status: string;
  reason?: string;
  settlementPaymentId?: string;
}
...
export interface CommissionSettings {
  ...
  fixedAmount: number;
  percentage: number;
  autoCalculateOnDeployment: boolean;
}

// Refund Settings
export interface RefundSettings {
  defaultContractMonths: number;
  partialMonthCalculation: string;
...
export interface GuaranteeSettings {
  ...
  autoGenerateDebits: boolean;
  includeVisaCost: boolean;
  includeTransportationCost: boolean;
  includeMedicalCost: boolean;
}
